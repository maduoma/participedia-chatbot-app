...
case_dataset_path = 'data_processing/raw_clean_data/Case Dataset.csv'
method_dataset_path = 'data_processing/raw_clean_data/Method Dataset.csv'
...
def preprocess_case_data():
    """
    Function to preprocess the Case Dataset. It will clean and transform the data
    as necessary, then save the cleaned data to a new CSV file.
    """
...
def preprocess_method_data():
    """
    Function to preprocess the Method Dataset. It will clean and transform the data
    as necessary, then save the cleaned data to a new CSV file.
    """
